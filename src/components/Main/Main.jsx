        ...
        <section className={style.content}>
            ...
            <div>
                ...
                <div className={style.content__columnText}>
                    <p className={style.content__text}>Благодаря Ensia, ты сможешь полностью познать себя с разных сторон - это поможет добиться высокой самореализации и стремительно идти по карьерной лестнице. </p>
                    <p className={style.content__text}>Сможешь понять восприятие тебя окружением и как именно произвести первое хорошее впечатление на людей. Это будет бонусом к построению отношений с мужчиной твоей мечты.</p>
                    <p className={style.content__text}>И наконец, ты сможешь ответить на главный вопрос: «что мне делать дальше?»</p>
                </div>
            </div>
